...
const typeConfig: Record<string, { icon: React.ReactNode; color: string }> = {
  ai_alert: { icon: <AlertTriangle className="w-5 h-5" />, color: "#5EEAD4" },
    ...
    <div>
      <div className="page-header">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          {unreadCount > 0 && (
            <button onClick={markAllRead} className="flex items-center gap-2 text-sm px-4 py-2 rounded-xl transition-colors cursor-pointer" style={{ background: "rgba(94, 234, 212,0.1)", color: "var(--solana-purple)" }}>
