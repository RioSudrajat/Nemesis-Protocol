...
export default function VehicleDetailPage({ params }: { params: Promise<{ vin: string }> }) {
  ...
  if (!vehicle) {
    return (
      <div className="flex flex-col items-center justify-center py-24">
        ...
        <Link href="/admin/vehicles" className="text-sm underline" style={{ color: "#5EEAD4" }}>Back to Vehicles</Link>
      </div>
    );
  }
  ...
  return (
    <div>
      <Link href="/admin/vehicles" className="inline-flex items-center gap-2 text-sm mb-6 hover:underline" style={{ color: "#5EEAD4" }}>
