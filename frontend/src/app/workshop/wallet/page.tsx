...
export default function WorkshopWalletPage() {
  return (
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm max-w-md" style={{ color: "var(--solana-text-muted)" }}>
            Fitur $NOC Wallet untuk workshop sedang dalam pengembangan. Nantikan di update selanjutnya.
          </p>
        </div>
