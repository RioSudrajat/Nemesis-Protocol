    ...
    <section className="relative w-full text-black py-32 z-10" style={{ backgroundColor: "#F4F4F4" }}>
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 mb-16">
          <h2 className="text-[3rem] md:text-[4rem] font-medium leading-[1.05] tracking-tighter text-[#111827] max-w-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5" style={{ gridAutoRows: "300px" }}>
          ...
          <div className="bg-white rounded-2xl p-8 flex flex-col justify-between hover:shadow-lg transition-all duration-300 cursor-pointer">
            <h3 className="text-[20px] font-semibold tracking-tight text-[#111827] leading-snug">Fractional<br />Ownership</h3>
          ...
          <div className="bg-white rounded-2xl p-8 flex flex-col justify-between hover:shadow-lg transition-all duration-300 cursor-pointer">
            ...
            <h3 className="text-[20px] font-semibold tracking-tight text-[#111827] leading-snug">Verifiable<br />Yield</h3>
          </div>

          <div className="bg-white rounded-2xl p-8 flex flex-col justify-between hover:shadow-lg transition-all duration-300 cursor-pointer">
            <h3 className="text-[20px] font-semibold tracking-tight text-[#111827] leading-snug">Proof of<br />Activity</h3>
            <p className="text-[#6B7280] text-[14px] font-medium leading-relaxed">
          ...
          <div className="bg-white rounded-2xl p-8 flex flex-col justify-between hover:shadow-lg transition-all duration-300 cursor-pointer">
            ...
            <h3 className="text-[20px] font-semibold tracking-tight text-[#111827] leading-snug">Smart Contract<br />Automation</h3>
          </div>
